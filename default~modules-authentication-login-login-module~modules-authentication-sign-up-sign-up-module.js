(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-authentication-login-login-module~modules-authentication-sign-up-sign-up-module"],{
...
/***/ "xCwu":
/*!********************************************!*\
  !*** ./src/app/shred/validations/regex.ts ***!
  \********************************************/
...
Regex.emailRegex = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,3}))$/;


/***/ })

}]);
//# sourceMappingURL=default~modules-authentication-login-login-module~modules-authentication-sign-up-sign-up-module.js.map